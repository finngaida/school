...
<div <?php generate_footer_class(); ?>>
					...
					<div class="footer-widget-1 grid-parent grid-<?php echo apply_filters( 'generate_footer_widget_1_width', $widget_width ); ?> tablet-grid-<?php echo apply_filters( 'generate_footer_widget_1_tablet_width', '50' ); ?>">
						<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-1')): ?>
							<aside class="widget inner-padding widget_text">
								<h4 class="widget-title"><?php _e('Kontakt','generate');?></h4>			
								<div class="textwidget">
									<p>Maurepasstraße 67</br>24558 Henstedt-Ulzburg</br>Deutschland</p>
									<p>Mail: <a href="mailto:kontakt@alstergymnasium-hu.de">kontakt@alstergymnasium-hu.de</a></br>Tel: +49 4193 123456</p>
								</div>
							</aside>
						<?php endif; ?>
					</div>
	...
	<footer class="site-info" itemtype="http://schema.org/WPFooter" itemscope="itemscope" role="contentinfo">
		<div class="inside-site-info grid-container grid-parent">
			Copyright 2016 Alstergymnasium Henstedt-Ulzburg
		</div>
	</footer><!-- .site-info -->
